//
//  SISLibraryTVCellWindowController.m
//  SISItemLibrary
//
...
@implementation SISLibraryTVCellWindowController
...
-(id) tableView:(NSTableView *)tableView objectValueForTableColumn:(NSTableColumn *)tableColumn row:(NSInteger)row 
{
    ...
    if ([columnIdentifer isEqualToString: kSISItemImage]) {
        returnValue = this.image;
    }
